...
impl Graphics {
    ...
    pub fn recursive_lines_x(canvas: &mut RgbImage, start: f32, line_width: u32, start_x: u32, spacing: u32, number_lines: u32, color: Rgb<u8>, rand: bool) {
        let factor = number_lines * spacing;
        for x in start_x..factor {
